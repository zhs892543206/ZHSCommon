package com.zhs.commonhelper.widget.autotext;
...
public class AutofitHelper {
    ...
    private static void autofit(TextView view, TextPaint paint, float minTextSize, float maxTextSize,
        ...
        int targetWidth = 0;
//        //byzhs 最好还是用getMaxWidth好，毕竟控件可能宽度是wrap，如果字多了自己会扩张的，只有到扩张不了的时候才停止.发现没效果
//        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN) {
//            targetWidth = view.getMaxWidth() - view.getPaddingLeft() - view.getPaddingRight();
//        }else{
